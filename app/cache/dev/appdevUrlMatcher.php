...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            ...
            return array (  '_controller' => 'Permiso\\AuthBundle\\Controller\\DefaultController::indexAction',  '_route' => '_welcome',);
        }
        ...
        // permiso_auth_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'permiso_auth_homepage');
            }

            return array (  '_controller' => 'Permiso\\AuthBundle\\Controller\\DefaultController::indexAction',  '_route' => 'permiso_auth_homepage',);
        }
